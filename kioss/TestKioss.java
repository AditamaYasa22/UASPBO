...
public class TestKioss extends JFrame {
    ...
    void simpanData(Kioss M) {
        try {
            Connection cn = new ConnectDB().getConnect();
            Statement st = cn.createStatement();
            String sql = "INSERT INTO kios (kode_barang, nama_barang, harga_barang, stok_barang) " +
    ...
    void hapusData(String kode_barang) {
        try {
            Connection cn = new ConnectDB().getConnect();
            Statement st = cn.createStatement();
            String sql = "DELETE FROM kios WHERE kode_barang = '" + kode_barang + "'";
            int result = st.executeUpdate(sql);
            cn.close();
    ...
    void ubahData(Kioss M, String kode_barang) {
        try {
            Connection cn = new ConnectDB().getConnect();
            Statement st = cn.createStatement();
            String sql = "UPDATE kios SET kode_barang='" + M.getkode_barang() + "', nama_barang='" + M.getnama_barang() + "', harga_barang='" + M.getharga_barang() + "', stok_barang='" + M.getstok_barang() + "' WHERE kode_barang='" + kode_barang + "'";
            int result = st.executeUpdate(sql);
            cn.close();
